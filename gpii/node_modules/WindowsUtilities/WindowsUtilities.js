...
windows.MODULEENTRY32 = new Struct([
    ...
    [t.HANDLE, "modBaseAddr"],  // declared as BYTE * in documentation
    [t.DWORD, "modBaseSize"],
    [t.HKL, "hModule"],
...
//        debugger;
        aProcess.modules = windows.listProcessModules(aProcess.pid);
...
//    debugger;
    while (hRes) {
        ...
        buf = new Buffer(mEntry.szExeFile);
        aModule.execPath = ref.readCString(buf, 0);
...
//    console.log ("MODULES FOR '" + pid + "': " + modules.length);
    return modules;
};
