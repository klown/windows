...
windows.listProcessModules = function (pid) {
    var modules = [];
    var hModuleSnap = windows.kernel32.CreateToolhelp32Snapshot(c.TH32CS_SNAPMODULE, pid);
    var mEntry = new windows.MODULEENTRY32();
    mEntry.dwSize = windows.MODULEENTRY32.size;
    var hRes = windows.kernel32.Module32First(hModuleSnap, mEntry.ref());
//    debugger;
    while (hRes) {
        var aModule = {};
        aModule.pid = pid;
        ...
        hRes = windows.kernel32.Module32Next(hModuleSnap, mEntry.ref());
    }
//    debugger;
    windows.kernel32.CloseHandle(hModuleSnap);
    return modules;
};
