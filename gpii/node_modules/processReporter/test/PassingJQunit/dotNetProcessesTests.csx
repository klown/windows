    ...
    public class GetProcessesTests
    {
        public async Task<object> Invoke(dynamic input)
        {
            ...
            try {
                ...
                Console.WriteLine( ((ProcInfo) processes[0]).command);
                testError = null;
            }
            catch (Exception e) {
                testError = e;
            ...
            // is called from a node process)
            int pid = ((ProcInfo) processes[0]).pid;
            try {
                Task<object> aTask = getProcesses.Invoke(pid);
                aTask.Wait();
                processes = (object[]) aTask.Result;
                Console.WriteLine( ((ProcInfo) processes[0]).command);
                testError = null;
            ...
            testResults.Add(new {
                ...
                message = "Command Name",
                expected = pid,
                actual = ((ProcInfo) processes[0]).pid,
                assert = "assertEquals",
                error = testError
            });
