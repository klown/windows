...
// Define JavaScript interfaces to the C# test methods
var testValidCommandName = edge.func({
...
var testInvalidCommandName = edge.func({
    source: path.join(__dirname, "dotNetProcessesTests.csx"),
    typeName: "gpii.windows.processes.tests.GetProcessesTests",
...
testValidCommandName({assert: runAssertions}, handleError);

testInvalidCommandName({assert: runAssertions}, function (error, result) {
...
testValidPid(validPidData, function (error, result) {
    console.log("JS, before error handling");
    if (error) { throw error; }
    console.log("JS, result is: " + result);
});

testInvalidPid({assert: runAssertions}, function (error, result) {
    console.log("JS, before error handling");
    if (error) { throw error; }
    console.log("JS, result is: " + result);
});

testNoArguments({assert: runAssertions}, function (error, result) {
    console.log("JS, before error handling");
    if (error) { throw error; }
    console.log("JS, result is: " + result);
});
