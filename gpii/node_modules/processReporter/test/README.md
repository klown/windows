...
Which is better?  I think it depends on how finely tuned the testing needs to be.  If the C# implementation is simple and nearly one-to-one with its JavaScript invocation, then the first method is sufficient.
